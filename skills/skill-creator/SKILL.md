...
5. 保存
   - パス: ~/.claude/skills/grid-{skill-name}/
   - 既存スキルと名前が被らないか確認

## 使用フロー

このスキルはOperatorがBossからの指示を受けて使用する。

1. Agentがスキル化候補を発見 → Operatorに報告
2. Operator → Bossに報告
3. **Bossが最新仕様をリサーチし、スキル設計を行う**
4. Bossが人間に承認を依頼（dashboard.md経由）
5. 人間が承認
6. Boss → Operatorに作成を指示（設計書付き）
7. **Operator がこのskill-creatorを使用してスキルを作成**
8. 完了報告

※ Bossがリサーチした最新仕様に基づいて作成すること。
※ Bossからの設計書に従うこと。
